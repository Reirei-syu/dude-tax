import type { ImportPreviewResponse, ImportSummary, ImportType } from "@dude-tax/core";
...
export const importSummaryRepository = {
  ...
  clearByUnitId(unitId: number) {
    database.prepare("DELETE FROM import_preview_summaries WHERE unit_id = ?").run(unitId);
  },
};
