...
export const buildAnnualResultVersionComparisonItems = (
  ...
  {
    label: "当前方案",
    baselineValue: schemeLabelMap[baselineVersion.selectedScheme],
    targetValue: schemeLabelMap[targetVersion.selectedScheme],
    deltaValue: formatChange(
      schemeLabelMap[baselineVersion.selectedScheme],
      schemeLabelMap[targetVersion.selectedScheme],
    ),
  },
  {
    label: "年度应纳税额",
  ...
  {
    label: "结算方向",
    baselineValue: settlementDirectionLabelMap[baselineVersion.settlementDirection],
    targetValue: settlementDirectionLabelMap[targetVersion.settlementDirection],
    deltaValue: formatChange(
      settlementDirectionLabelMap[baselineVersion.settlementDirection],
      settlementDirectionLabelMap[targetVersion.settlementDirection],
    ),
  },
  {
    label: "工资收入合计",
  ...
  },
  {
    ...
    deltaValue: formatDelta(targetVersion.otherDeductionTotal - baselineVersion.otherDeductionTotal),
  },
];
